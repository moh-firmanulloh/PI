<div class="content container" style="margin-bottom: 23.8%;">
	...
	<label><?php echo $prog->kategori; $prog_percent = ($prog->progress/$prog->target)*100?></label>
	<input type="text" value="<?php echo $prog_percent; ?>" class="dial" readonly data-min="0" data-max="100">
	<?php } ?>
	</div>
</div>
